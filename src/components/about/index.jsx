    ...
    <section className="py-20 w-full">
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          ...
          I'm Amit Kumar, an MSc Electronic Science student at Delhi University with a passion for electronics and digital marketing. With experience in circuit design, embedded systems, and freelance SEO and web development, I combine technical expertise with marketing strategies to deliver comprehensive solutions.
          </p>
        </ItemLayout>
        ...
        <ItemLayout className={"col-span-full md:col-span-6 !p-0"}>
          <img
            ...
            src="https://streak-stats.demolab.com?user=amitkr26&theme=dark&hide_border=true&type=png&background=EB545400&ring=EBE02D&currStreakLabel=EBD830"
            alt="Amitkr26"
            loading="lazy"
          />
        </ItemLayout>
        ...
        <ItemLayout className={"col-span-full md:col-span-6 !p-0"}>
          <Link
            href="https://github.com/amitkr26/Amitkr26-Portfolio"
            target="_blank"
            className="w-full"
          >
            <img
              ...
              src="https://github-readme-stats.vercel.app/api/pin/?username=amitkr26&repo=Amitkr26-Portfolio&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=false&description_lines_count=2"
              alt="Amitkr26"
              loading="lazy"
            />
          </Link>
